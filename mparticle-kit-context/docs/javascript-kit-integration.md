# Kit Integrations | JavaScript Kit Integration
...
## [](https://docs.mparticle.com/developers/guides/partners/kit-integrations/javascript-kit/#kit-overview)Kit Overview
...
### [](https://docs.mparticle.com/developers/guides/partners/kit-integrations/javascript-kit/#configuration)Configuration
...
## [](https://docs.mparticle.com/developers/guides/partners/kit-integrations/javascript-kit/#environment-setup)Environment Setup

In order to build and iterate on your kit, there are a few steps to get up and running:

### [](https://docs.mparticle.com/developers/guides/partners/kit-integrations/javascript-kit/#getting-started)Getting Started
...
### [](https://docs.mparticle.com/developers/guides/partners/kit-integrations/javascript-kit/#implementation)Implementation
...
## [](https://docs.mparticle.com/developers/guides/partners/kit-integrations/javascript-kit/#api-overview---building-your-integration)API Overview - Building Your Integration
...
### [](https://docs.mparticle.com/developers/guides/partners/kit-integrations/javascript-kit/#kit-interfaces)Kit Interfaces

#### [](https://docs.mparticle.com/developers/guides/partners/kit-integrations/javascript-kit/#initialization)Initialization
...
#### [](https://docs.mparticle.com/developers/guides/partners/kit-integrations/javascript-kit/#commerce-handler)Commerce Handler
...
#### [](https://docs.mparticle.com/developers/guides/partners/kit-integrations/javascript-kit/#event-handler)Event Handler
...
#### [](https://docs.mparticle.com/developers/guides/partners/kit-integrations/javascript-kit/#identity-handler)Identity Handler

Kits should implement this interface when their underlying service has the notion of a user with identities. You can read more about mParticle’s Identity system [here](https://docs.mparticle.com/developers/client-sdks/web/idsync/).

#### [](https://docs.mparticle.com/developers/guides/partners/kit-integrations/javascript-kit/#session-handler)Session Handler
...
#### [](https://docs.mparticle.com/developers/guides/partners/kit-integrations/javascript-kit/#user-attribute-handler)User Attribute Handler

Kits should implement this interface when their underlying service has the notion of a user with attributes.

### [](https://docs.mparticle.com/developers/guides/partners/kit-integrations/javascript-kit/#unitintegration-tests)Unit/Integration Tests
...
## [](https://docs.mparticle.com/developers/guides/partners/kit-integrations/javascript-kit/#end-to-end-testing)End-to-End Testing
...
## [](https://docs.mparticle.com/developers/guides/partners/kit-integrations/javascript-kit/#publishing-your-kit)Publishing Your Kit
...
3.  Once your code is live and available via NPM, follow the [SDK docs](https://docs.mparticle.com/developers/) to perform a basic instrumentation of mParticle, using the application key and secret provided to you by mParticle.
...
## [](https://docs.mparticle.com/developers/guides/partners/kit-integrations/javascript-kit/#additional-ecommerce-helpers)Additional eCommerce Helpers
...
Other eCommerce events map their event names similar to the above in snake case. See here [product action types](https://github.com/mparticle-by-rokt/mparticle-sdk-javascript-private/blob/master/src/types.js#L246-L269) as well as [promotion action types](https://github.com/mparticle-by-rokt/mparticle-sdk-javascript-private/blob/master/src/types.js#L279-L288). ie:
...
---
Source: [Kit Integrations | JavaScript Kit Integration](https://docs.mparticle.com/developers/guides/partners/kit-integrations/javascript-kit/)