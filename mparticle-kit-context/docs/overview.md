...
-   Android
    ...
    -   [Development Guide](https://docs.mparticle.com/developers/guides/partners/kit-integrations/android-kit/)
-   iOS
    
    -   [Example Kit](https://github.com/mparticle-integrations/mparticle-apple-integration-example)
    -   [Development Guide](https://docs.mparticle.com/developers/guides/partners/kit-integrations/ios-kit/)
-   Web
    
    -   [Example Kit](https://github.com/mparticle-integrations/mparticle-javascript-integration-example)
    -   [Development Guide](https://docs.mparticle.com/developers/guides/partners/kit-integrations/javascript-kit/)
...
---
Source: [Kit Integrations | Overview](https://docs.mparticle.com/developers/guides/partners/kit-integrations/overview/)